...
function page(post, slug, collection) {
  ...
  const externalLink = post.link ? `<p><a class="back-link" href="${escapeHtml(post.link)}">${escapeHtml(post.linkLabel || 'Visit project')} <span class="link-arrow">↗︎</span></a></p>` : '';
  return `<!doctype html>
