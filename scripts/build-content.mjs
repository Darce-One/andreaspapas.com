...
function page(post, slug, collection) {
  ...
  const nav = Object.keys(collections).map((key) => `<a href="../${collections[key].archive}"${key === collection ? ' aria-current="page"' : ''}>${collections[key].label}</a>`).join('');
  return `<!doctype html>
...
<body><a class="skip-link" href="#main">Skip to content</a><header class="site-header shell"><a class="wordmark" href="../../index.html">Andreas Papaeracleous<span>.</span></a><button class="menu-button" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="site-nav"><span></span><span></span></button><nav id="site-nav" class="site-nav" aria-label="Main navigation"><a href="../../index.html">Home</a>${nav}<a href="../contact.html">Contact</a><a href="../../music-share/index.html">Music Share</a></nav></header><main id="main"><article class="post"><header class="post-header"><p class="eyebrow">${section.eyebrow}</p><h1>${escapeHtml(post.title)}</h1>${subtitle}<p class="post-date">${escapeHtml(displayDate(post.date))}</p></header><div class="post-body">${renderMarkdown(post.body)}${externalLink}</div><a class="back-link" href="../${section.archive}">← ${section.heading}</a></article></main><footer class="site-footer shell"><a class="wordmark" href="../../index.html">Andreas Papaeracleous<span>.</span></a><p>© <span id="year"></span> Andreas Papaeracleous.</p></footer><script src="../../script.js"></script></body></html>`;
}
